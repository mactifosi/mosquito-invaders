...
const LAYOUTS = [
  ...
  // Reeds: short stubs and frequent junctions — more decisions per second, and
  // more chances to cut a corner a hunter can't.
  {
    top: [["########", "#"], ["#.......", "#"], ["#.#.##.#", "#"], ["#o#.##.#", "."],
          ["#.......", "."], ["#.##.##.", "#"], ["#....#..", "."]],
    bottom: [["#....#..", "."], ["#.##.##.", "#"], ["#.......", "."], ["#o#.##.#", "#"],
  ...
  // Basin: concentric rings. Long loops to run, and the carrots sit out at the
  // rim where you have to commit to reach them.
  {
    top: [["########", "#"], ["#.......", "."], ["#.##.#.#", "#"], ["#o##.#.#", "."],
          ["#....#..", "."], ["#.##.#.#", "#"], ["#....#..", "."]],
    bottom: [["#....#..", "."], ["#.##.#.#", "#"], ["#....#..", "."], ["#o##.#.#", "."],
